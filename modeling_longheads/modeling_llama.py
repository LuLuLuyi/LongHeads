...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.global_feature_proj = nn.Linear(self.window_size, 1, bias=True)
        # self.conv = nn.Conv2d(2,1,self.head_dim)
    ...
    def forward(
        ...
        if ori_len > 1:
            ...
            if chunk_features_key is None or g > chunk_features_key.size()[-2]:
